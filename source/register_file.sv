...
module register_file(
    ...
    always_comb begin
        rfif.rdat1 = (rfif.rsel1 == '0)? '0: register[rfif.rsel1];
        rfif.rdat2 = (rfif.rsel2 == '0)? '0: register[rfif.rsel2];
    end
    ...
    // always_comb begin
    //     // next_WEN = WEN;
    //     en = '0;rfif.rdat1 = (rfif.rsel1 == '0)? '0: register[rfif.rsel1];
    //     if (rfif.WEN) begin
    //         casez (rfif.wsel)
    ...
    //             defaulrfif.rdat1 = (rfif.rsel1 == '0)? '0: register[rfif.rsel1];t: en = '0;
    //         endcase
    //     end
    //     // else begin
    //         // en = '0;
